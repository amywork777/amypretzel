...
/* Monochrome fish glyph for the home footer easter-egg link.
   Adapted from a public-domain svgrepo source; fill collapsed to
   currentColor so the icon takes the link's color. */
export function FishIcon({ className }: Props) {
  return (
    <svg
      viewBox="-2 -7 24 24"
      fill="currentColor"
